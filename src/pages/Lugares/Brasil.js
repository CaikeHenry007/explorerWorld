...
const SPACING = 20;
  ...
  const data= [
    ...
    {
      source: require("../../images/imagesAmericaSul/capitolioBrasil.jpg"),
      title: "Capitólio",
    },
    {
      source: require("../../images/imagesAmericaSul/JardimbotanicoBrasil.jpg"),
      title: "Jardim Botânico - Curitiba",
    },
    {
      source: require("../../images/imagesAmericaSul/cataratasDoIguaçuBrasil.jpg"),
      title: "Cataratas do Iguaçu",
    },
    {
      source: require("../../images/imagesAmericaSul/betoCarreroBrasil.jpg"),
...
const Carousel = () => {
 ...
 return(
  <View>
    ...
    <TouchableOpacity
                onPress={() => navigation.navigate("AmericaSul")}
                style={{
                  alignItems: "center",
