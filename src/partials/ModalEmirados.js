import {
  ...
  export default function EmiradosModal({ visibleEmirados, closeEmirados }) {
    ...
    const places = [
      ...
      {
        source: require("../images/Asia/burj.jpg"),
        title: "Burj Khalifa",
      },
      {
        source: require("../images/Asia/ferrari.jpg"),
        title: "Ferrari World",
      },
      {
        source: require("../images/Asia/museuFuturo.jpg"),
        title: "Museum of The Future",
      },
    ];
  
    return (
      <Modal transparent={true} animationType="fade" visible={visibleEmirados}>
        <View style={{ flex: 1, backgroundColor: "#F4CFBA" }}>
          <View style={{ width: "100%", height: "45%", borderBottomEndRadius: 40 }}>
  
            <ImageBackground source={require("../images/Asia/emirados.jpg")}
              ...
              <View style={{ height: "80%", width: "100%", alignItems: "center", justifyContent: "flex-end" }}>
                <Text style={stylesPaises.TitlePaises} >Emirados Árabes Unidos</Text>
              </View>
            </ImageBackground>
          </View>
