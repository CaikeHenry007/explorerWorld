import {
  ...
  export default function JapaoModal({ visibleJapao, setVisibleJapao }) {
    ...
    const places = [
      {
        source: require("../images/Asia/parqueTema.jpg"),
        title: "Universal Studios Japan",
      },
      {
        source: require("../images/Asia/dotonbory.jpg"),
        title: "Dotonbori",
      },
      {
        source: require("../images/Asia/nara.jpg"),
        title: "Parque de Nara",
      },
      {
        source: require("../images/Asia/museuToquio.jpg"),
        title: "Museu Nacional de Tóquio",
      },
    ];
  
    return (
      <Modal transparent={true} animationType="fade" visible={visibleJapao}>
        <View style={{ flex: 1, backgroundColor: "#F4CFBA" }}>
          <View style={{ width: "100%", height: "45%", borderBottomEndRadius: 40 }}>
  
            <ImageBackground source={require("../images/Asia/japao.jpg")}
              ...
              <View style={{ height: "80%", width: "100%", alignItems: "center", justifyContent: "flex-end" }}>
                <Text style={stylesPaises.TitlePaises} >Japão</Text>
              </View>
            </ImageBackground>
          </View>
