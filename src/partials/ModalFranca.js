import {
  ...
  export default function FrancaModal({ visibleFranca, setVisibleFranca }) {
          ...
          <View style={{ width: "100%", height: "45%", borderBottomEndRadius: 40 }}>
            ...
            <ImageBackground source={require("../images/Europa/frança.jpg")}
              ...
              <View style={{ flexDirection: "row", height: "20%", width: "100%" }} >
                ...
                <Pressable onPress={() => setVisibleFranca(false)} style={{ alignItems: "center", justifyContent: "flex-start", width: "10%" }} >
              ...
              <View style={{ height: "80%", width: "100%", alignItems: "center", justifyContent: "flex-end" }}>
                <Text style={stylesPaises.TitlePaises} >França</Text>
              </View>
            </ImageBackground>
          </View>
