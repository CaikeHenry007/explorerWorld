...
import { useFonts } from "expo-font";
  ...
  export default function ArgentinaModal({ visibleArgentina, closeArgentina }) {
    ...
    return (
      <Modal transparent={true} animationType="fade" visible={visibleArgentina}>
        <View style={stylesPaises.containerModal}>
          <View style={stylesPaises.TopViewModal}>
  
            <ImageBackground source={require("../images/imagesAmericaSul/argentina.jpg")}
              ...
              <View style={stylesPaises.txtTitle}>
                <Text style={stylesPaises.TitlePaises}>Argentina</Text>
              </View>
            </ImageBackground>
          </View>
