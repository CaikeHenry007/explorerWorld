import {
  ...
  export default function HondurasModal({ visibleHonduras, setVisibleHonduras }) {
    ...
    return (
      <Modal transparent={true} animationType="fade" visible={visibleHonduras}>
        <View style={{ flex: 1, backgroundColor: "#F4CFBA" }}>
          <View style={{ width: "100%", height: "45%", borderBottomEndRadius: 40 }}>
  
            <ImageBackground source={require("../images/imagesAmericaCentro/honduras.jpg")}
              style={{ height: "100%", borderBottomEndRadius: 40, flexDirection: "column" }}
              resizeMode="cover" >
              <View style={{ flexDirection: "row", height: "20%", width: "100%" }} >
  
                <Pressable onPress={() => setVisibleHonduras(false)} style={{ alignItems: "center", justifyContent: "flex-start", width: "10%" }} >
              ...
              <View style={{ height: "80%", width: "100%", alignItems: "center", justifyContent: "flex-end" }}>
                <Text style={stylesPaises.TitlePaises}>Honduras</Text>
              </View>
            </ImageBackground>
          </View>
