import {
  ...
  export default function AustraliaModal({ visibleAustralia, closeAustralia }) {
          ...
          <View style={{ width: "100%", height: "45%", borderBottomEndRadius: 40 }}>
            ...
            <ImageBackground source={require("../images/Oceania/oceania.jpg")}
              ...
              <View style={{ flexDirection: "row", height: "20%", width: "100%" }} >
                ...
                <Pressable onPress={closeAustralia} style={{ alignItems: "center", justifyContent: "flex-start", width: "10%" }} >
