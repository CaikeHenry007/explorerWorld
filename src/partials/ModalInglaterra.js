import {Text,View,ImageBackground,TouchableOpacity,Modal,Pressable,FlatList,Image} from "react-native";
  ...
  export default function InglaterraModal({ visibleInglaterra, closeInglaterra }) {
    ...
    return (
      <Modal transparent={true} animationType="fade" visible={visibleInglaterra}>
        <View style={{ flex: 1, backgroundColor: "#F4CFBA" }}>
          <View style={{ width: "100%", height: "45%", borderBottomEndRadius: 40 }}>
  
            <ImageBackground source={require("../images/Europa/inglaterra.jpg")}
              ...
              <View style={{ height: "80%", width: "100%", alignItems: "center", justifyContent: "flex-end" }}>
                <Text style={stylesPaises.TitlePaises} >Inglaterra</Text>
              </View>
            </ImageBackground>
          </View>
